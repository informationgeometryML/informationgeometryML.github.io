...
discuss in <!--[Part IV]({{ site.baseurl }}{ post_url 2021-11-15-Geomopt04 }#proximal-gradient-descent).   --> Part IV However, the derivation has the following limitations:
...
Part III) <!--[Part III]({{ site.baseurl }}{ post_url 2021-11-02-Geomopt03 }#riemannian-steepest-direction-is-invariant) ) -->
...
`$\tau_1$`, which involves the concept of [parallel transport](https://en.wikipedia.org/wiki/Parallel_transport) in a curved space. For simplicity, we aviod defining it since it involves derivatives of the Fisher-Rao metric (also known as the [Christoffel symbols](
