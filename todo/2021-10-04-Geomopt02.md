...
Moreover, a natural gradient (in a gradient space) is invariant as shown in Part III while a natural-gradient update (in a parameter space) is only linearly invariant as discussed in Part IV.
...
We will discuss more about this in <!-- [Part IV]({{ site.baseurl }}{ post_url 2021-11-15-Geomopt04 }#two-kinds-of-spaces). --> Part IV. 
