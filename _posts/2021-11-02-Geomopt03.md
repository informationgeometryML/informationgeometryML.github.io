...
As we will discuss more in Part V, computing Riemannians gradient with this Newton  metric are often more computaitonally intensive compared to the Fisher-Rao metric. Moreover, Riemannians gradient with this Newton  metric are dependent on the convexity of the loss function (see more about this in Part V).
