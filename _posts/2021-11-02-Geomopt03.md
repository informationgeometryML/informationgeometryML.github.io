...
It is obvious that this gradient direction in Newton's method is invariant since it is a speical case of the Riemannian steepest direction.
...
As we will discuss more in Part V, computing Riemannians gradient with this Newton  metric are often more computaitonally intensive compared to the Fisher-Rao metric. Moreover, Riemannians gradient with this Newton  metric are dependent on the choise of a loss function (see more about this in Part V).
