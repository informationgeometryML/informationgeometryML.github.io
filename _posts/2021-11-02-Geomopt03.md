...
Goal
------
This blog post focuses on the invariance of natural-gradients.
We will discuss
* transformation rules related to natural-gradients and the computation via Automatic Differentiation.

* the non-invariance of the Euclidean counterpart.
...
this invariance property implies that natural-gradient descent is linearly invariant.
...
Moreover, Euclidean gradient descent is not invariant under a parameter transformation. We will cover more about this in 
Part IV.
<!--[Part IV]({{ site.baseurl }}{ post_url 2021-11-15-Geomopt04 })-->
...
[^2]: We assume readers are familar with the transformation rule for Euclidean gradients. In differential geometry, this transformation rule can also be shown by using an abstract coordinate map. We avoid defining this map for simplicity.
