...
*  In K-[dimensional]({{ site.baseurl }}{% post_url 2021-09-06-Geomopt01 %}#dimensionality-of-a-manifold) manifold cases,  `$\Omega_\tau \subset T_{\tau_0} (\Omega_\tau)=\mathcal{R}^K$` illustrated by the following figure.
</div>
