...
By choosing an intrinsic parametrization, this update is also valid in the **parameter space**  (see the red space in the above figure) as long as the step-size is small
enough.
