...
[^1]: In Riemannian geometry, a geodesic is induced by Levi-Civita connection. This connection is known as a metric compatiable parallel transport. Christoffel symbols are used to represent the connection in a coordinate/parametrization system.
