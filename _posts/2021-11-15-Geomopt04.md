...
hi
Notices that Euclidean gradients follow the [transformation rule]({{ site.baseurl }}{% post_url 2021-11-02-Geomopt03 %}#transformation-rules-for-natural-gradients-and-euclidean-gradients)  as
...
&=\mathbf{J}^T\nabla_\tau (  \mathbf{g}_{\lambda_k} ) \,\,\,\,\text{(for a linear transformation, } \mathbf{J} \text{ is a
constant matrix)}   \\
