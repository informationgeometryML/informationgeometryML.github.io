...
To avoid writing down the differential equations of a geodesic[^1] (i.e., [Christoffel symbols](https://en.wikipedia.org/wiki/Levi-Civita_connection#Christoffel_symbols) or [connection 1-form](https://en.wikipedia.org/wiki/Connection_form#Example:_the_Levi-Civita_connection)), 
