...
`$$
\begin{aligned}
\mathbf{m}_{k+1} \leftarrow \arg \min_{x \in \Omega_m}\{ \langle \nabla_m f(\mathbf{m}_k), \mathbf{x}-\mathbf{m}_k  \rangle + \frac{1}{\alpha}  \mathrm{B}_{A^*_\eta}(\mathbf{x},\mathbf{m}_k) \}
\end{aligned}
$$`
...
\begin{aligned}
u(\mathbf{x}) &:=\langle \nabla_m f(\mathbf{m}_k), \mathbf{x}-\mathbf{m}_k  \rangle + \frac{1}{\alpha} [ \mathrm{B}_{A^*_\eta}(\mathbf{x},\mathbf{m}_k)] \\
& = \langle \nabla_m f(\mathbf{m}_k), \mathbf{x}-\mathbf{m}_k  \rangle + \frac{1}{\alpha}  [A^*_\eta( \mathbf{x}) - A^*_\eta( \mathbf{m}_k) -    
...
&= \nabla_m f(\mathbf{m}_k)+ \frac{1}{\alpha}  [\underbrace{ \nabla_x A^*_\eta( \bar{\mathbf{x}})}_{\eta_{\bar{x}}}  -  \eta_k ],
\end{aligned}
$$` which implies that
`$\eta_{\bar{x}} = \eta_k - \alpha \nabla_m f(\mathbf{m}_k)$`.

Note that `$\eta_{\bar{x}}$` is the corresponding natural parameter for the expectation
`$\mathbf{m}_{k+1}$`.
Therefore, unconstrained mirror descent in the expectation parameter space `$\Omega_m$` gives 
...
descent in the natural parameter space `$\Omega_\eta$`.
