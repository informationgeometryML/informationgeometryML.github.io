---
title: 'Basics of Information Geometry (1)'
date: 2021-09-06
...
A remark is that an arbitrary Riemannian metric could be useless for applications in machine learning. The Fisher-Rao metric is special  since it is closely related to  maximum likelihood estimation, central limit theorem, and differential entropy.
