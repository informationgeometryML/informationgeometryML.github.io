...
* design efficient and simple algorithms for machine learning
* design methods that are robust and invariant to re-parametrization 
* better understand algorithmic behaviors through the lens of differentiable symmetries and conservation laws
...
> $$`
>
> The output of the inverse map `$\mathrm{MatH}(\mathbf{v})$` is
> `$$
