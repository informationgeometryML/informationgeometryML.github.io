...
>
>The **natural-gradient variational inference** {% cite khan2017conjugate  %} is an algorithm that speeds up the inference by exploiting the geometry of `$q(z|\tau)$` induced by the Fisher-Rao metric. This approach can be generalized to neural network cases {% cite osawa2019practical %} {% lin2021tractable %} from a Bayesian viewpoint
