...
It supports local **vector additions**,  local **real scalar products**, and the well-known algebraic laws (i.e., the distributive law) associated these two operations. (see [Part II]({{ site.baseurl }}{% post_url 2021-10-04-Geomopt02 %}#riemannian-gradients-as-tangent-vectors-optional) for the details.) 
</div>
