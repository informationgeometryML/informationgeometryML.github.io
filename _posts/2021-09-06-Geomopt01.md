...
>`$$
>\begin{aligned} 
>F(\mathrm{vec}(\Sigma_0)) & = E_{p_1(w|\Sigma) } [  - \nabla_{\mathrm{vec}(\Sigma) }^2 \log p_1(w|\Sigma) ] \Big|_{\Sigma=\Sigma_0} = \begin{bmatrix} 0.5 &  0 & 0 & 0 \\ 0 &  -0.25 & 0.75 & 0 \\ 0 &  0.75 & -0.25 & 0\\ 0 &  0 & 0 & 0.5\end{bmatrix}
