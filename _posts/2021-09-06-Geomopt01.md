...
We refer to the parametrizations that satisfy the following conditions as an intrinsic parameterization [^1], which as we will see will lead to non-singular FIMs of `$K$`-by-`$K$`.
