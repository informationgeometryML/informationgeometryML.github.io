...
when we speicify these two parametrizations.
...
Recall that an intrinsic parameterization must satisfy the conditions in openness, smooth, and uniquenss.
