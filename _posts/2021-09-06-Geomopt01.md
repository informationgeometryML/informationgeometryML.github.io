...
>
>The reason is that we do not uniquely represent a point in the circle. It is obivous to see that  $\tau$ and $\alpha \tau$ both represent the same point in the circle when scalar $\alpha>0$.
>
