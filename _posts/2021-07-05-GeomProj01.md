...
We propose using retraction map `$\mathbf{h}()$` to
* keep natural-gradient computation tractable
* maintain numerical stability
* have much lower iteration cost compared to the matrix exponential map suggested in {% cite glasmachers2010exponential %}
</div>
