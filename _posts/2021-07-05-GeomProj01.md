...
About this work {% cite lin2021tractable %}: [(Youtube) talk](https://www.youtube.com/watch?v=vEY1ZxDJX8o&t=11s), [ICML paper](https://arxiv.org/abs/2102.07405), [workshop paper](https://arxiv.org/abs/2107.10884),
...
* yields new structured second-order algorithms and structured adaptive-gradient methods {%  cite lin2021structured %}
