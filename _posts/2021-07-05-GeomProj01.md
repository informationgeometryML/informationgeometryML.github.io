...
|:--:|:--|
|: Performance of our method with sparse group structures (lower-trinagular, upper-trinagular, Heisenberg upper-triangular, Heisenberg lower-triangular), Adam, and BFGS  :||
...
|:--:|:--|
|: Comparison between our method with Kronecker product groups and Adam :||
...
<fieldset class="field-set" markdown="1">
First 8 marginal distributions of our approximation (Gaussians mixture with a block upper-triangular group, where `$k=5$`)

| <img src="/img/icml2021-tmm80d-01.png"  width="90%"/> |  <img src="/img/icml2021-tmm80d-02.png"  width="90%"/> | 
|:--:|:--|
|: Comparison between our approximation and the ground-truth :||
