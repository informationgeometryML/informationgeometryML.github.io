...
*  Posterior Gaussian approximation for variational inference 

Natural-gradient descent on structured parameter spaces is computationally challenging.

Existing NGD works
* Limited structures and singularity of the Fisher information matrix (FIM)
* Ad-hoc approximations for cost reductions 
* Complicated and inefficient NG computation 
* Lack of a systemic approach to incorporate a range of structures
