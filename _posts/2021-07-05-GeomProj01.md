...
The second-order term shown in red is used for the parameter constraint {% cite  lin2020handling %} in Riemannian gradient descent (RGD).  A higher-order term `$O(\beta^3)$` will be used for structured precision. 
