...
*  Preconditioners of gradient-free, first-order, and second-order methods 
*  Covariance matrices of variational Gaussian approximation {% cite opper2009variational %}
...
Block lower<br> triangular | Block upper<br> triangular | Hierarchical<br> (Heisenberg) | Kronecker product | Triangular-Toeplitz | Sparse Cholesky
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
...
|:--:|:--|
|: <font size="3"> Performance of our method with group structures (lower-trinagular, upper-trinagular, Heisenberg upper-triangular, Heisenberg lower-triangular), Adam, and BFGS </font> :||
...
|: <font size="4"> Kronecker product of lower-triangular groups for a CNN </font> :||
...
|: <font size="4"> First 8 marginal distributions of our structured Gaussian mixture approximation with a block upper-triangular structure </font> :||
| <img src="/img/icml2021-tmm80d-01.png"  width="90%"/> |  <img src="/img/icml2021-tmm80d-02.png"  width="90%"/> | 
|:--:|:--|
|:  <font size="4"> Comparison between our approximation and the ground-truth </font> :||
