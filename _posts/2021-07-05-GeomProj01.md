...
Block Lower triangular | Block Upper triangular | Hierarchical<br> (Heisenberg) | Kronecker product | Triangular-Toeplitz | Sparse Cholesky
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
...
>       `$$
>           \begin{aligned}
>                &\mathbf{h}\big(\mathbf{M}\big) \in {\cal{B}_{\text{up}}}(k) \text{ for }  \mathbf{M} \in \text{ Lie sub-algebra } \cal{M}_{\text{up}}(k) \,\,\,\,  &(\text{by design, } \mathbf{h}(\cdot) \text{ is a Lie-group retraction map}) \\
