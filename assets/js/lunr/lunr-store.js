var store = [{
        ...
        "excerpt":"Warning: working in Progress (incomplete) Handling Parameter Constraints Recall that in Part IV, we discuss the many faces of NGD in unconstrained cases. These methods could also be exteneded in constrained cases to handle the parameter constraint. By using a natural parameterization $\\eta$ with parameter constraint $\\Omega_\\eta$, consider the following...","categories": [],
        "tags": ["Natural Gradient Descent","Information Geometry","Riemannian Manifold","Exponential Family"],
