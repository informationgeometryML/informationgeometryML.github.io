var store = [{
        ...
        "excerpt":"More about this work [1]: (Youtube) talk, extended paper, short paper,poster Introduction Motivation Many problems in optimization, inference, and search can be solved via natural-gradient descent (NGD) Structures play an essential role in Preconditioners for gradient-free, first-order, and second-order methods Covariance matrices in variational Gaussian approximation [2]Natural-gradient descent on structured...","categories": [],
